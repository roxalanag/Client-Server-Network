...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvt(int sd, Storage *storage, EVP_CIPHER_CTX *ctx,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kvf(int sd, Storage *storage, EVP_CIPHER_CTX *ctx,
                const std::vector<uint8_t> &req);
...
///
/// @return false, to indicate that the server shouldn't stop
bool handle_kmr(int sd, Storage *storage, EVP_CIPHER_CTX *ctx,
                const std::vector<uint8_t> &req);